        ...
        <div class="wp-section">
            <div class="container">
                ...
                <div id="carouselConsultancy" class="carousel carousel-3 slide animate-hover-slide">
                    ...
                    <div class="carousel-inner">
                     <?php $incrs = 0; $class = "active"; ?>
						@foreach($consultancy as $consultancys)
              <?php   //echo '<pre>';print_r($profile); ?>
                    <?php $incrs++;  ?>
                       <?php if($incrs == 1){  echo '<div class="item ' . $class . '"><div class="row">';  }?>
						   ...
						   <div class="client">
                            <a href="#">
								...
								@if(($consultancys->logoCategory != "")&&($consultancys->logoName))
                                                        <img src="<?php echo url('/'); ?>/companylogo.get/{{ $consultancys->logoCategory }}/{{ $consultancys->dirYear }}/{{ $consultancys->dirMonth }}/{{ $consultancys->logoName }}/{{ $consultancys->crTime }}/s.{{ $consultancys->logExt }}" class="img-responsive" style="width:1000%"  alt="">
														@endif
                            </a>
                        </div>
                           </a>
