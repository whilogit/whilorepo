                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <label class="select">
                                                       ...
                                                       <option {{ isset($personal->marital) ?  $personal->marital == 1 ? "selected" : '' : '' }} value="1">Yes</option>
                                                       <option {{ isset($personal->marital) ?  $personal->marital == 0 ? "selected" : '' : '' }} value="0">No</option></select>
                                                    </label>
                                                </div>               
                                            </div>
