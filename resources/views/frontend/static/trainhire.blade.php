...
<div class="body-wrap">
  ...
  <!-- MAIN CONTENT -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h2>Train Hire & Deploy</h2>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        <li><a href="#">Home</a></li>
                        <li><a href="#">Pages</a></li>
                        <li class="active">Train Hire & Deploy</li>
                    </ol>
                </div>
            </div>
        </div>
   ...
   <section class="slice bg-base" style="background: #242738;">
           <div class="wp-section">
            <div class="container">
                <div class="row"><h4 class="col-md-12">Train Hire & Deploy</h4>
                    <div class="col-md-12"><p>
                       We have developed the "Hire, Train & Deploy" model as part of our ongoing commitment to providing cost-effective skilled talents that help our clients deliver world class projects efficiently. <br/><br/>
This program is specially designed for our valued customers who have special needs for their new staff to be trained in specific areas before they come on board. <br/><br/>

Contact our <span style="color:red">Hiring Principle</span> for customized hiring & training requirements.
