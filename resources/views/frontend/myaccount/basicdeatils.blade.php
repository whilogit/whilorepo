...
@if(count($company_logo) > 0)
                   <div  align="center"><img width="100%" src="/display/image/{{ $company_logo->logoCategory }}/{{ $company_logo->dirYear }}/{{ $company_logo->dirMonth }}/{{ $company_logo->logoName }}/{{ $company_logo->crTime }}/l.{{ $company_logo->logExt }}"  class="img-circle" kasperskylab_antibanner="on"> 
