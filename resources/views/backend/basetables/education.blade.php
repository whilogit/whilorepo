                                         ...
                                         @foreach($data['education'] as $list) <?php $i = $i + 1; ?>
                                                <tr role="row" class="odd">
                                                        ...
                                                        <td>{{ $list->educationName }}</td>
                                                         <td><button  class="btn btn-danger fa fa-pencil-square locationsedit" name="edit" value="edit" data-locid="<?php echo $list->educationId ?>" data-locname="<?php echo $list->educationName ?>"></button></td>
                                                <td><button  class="btn btn-danger fa fa-trash locationsdelete" name="delete" value="Delete" data-locid="<?php echo $list->educationId ?>"></button></td>
                                                </tr>
                                         @endforeach
