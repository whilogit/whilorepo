                            ...
                            <div id="table_div">
                                ...
                                <th width="1%">Edit</th>
                                 <th width="1%">Delete</th>
                                   ...
                                   <tbody><?php $i=0; ?>
                                         @foreach($data['qualification'] as $list) <?php $i = $i + 1; ?>
                                                <tr role="row" class="odd">
                                                        <td><?php  echo $i; ?></td>
                                                        <td>{{ $list->qualificationName }}</td>
                                                         <td><button  class="btn btn-danger fa fa-pencil-square locationsedit" name="edit" value="edit" data-locid="<?php echo $list->qualificationId ?>" data-locname="<?php echo $list->qualificationName ?>"></button></td>
                                                <td><button  class="btn btn-danger fa fa-trash locationsdelete" name="delete" value="Delete" data-locid="<?php echo $list->qualificationId ?>"></button></td>
                                                </tr>
                                         @endforeach
...
$(document).ready(function () {
    ...
    $("#edit_posting").click(function () {
        ...
        $.ajax({
            url: '/dashboard/editqualification',
            type: 'POST',
            processData: false,
            contentType: false,
            data: formValues,
    ...
    $("#delete_posting").click(function () {
        ...
        $.ajax({
            url: '/dashboard/deletequalification',
            type: 'POST',
            processData: false,
            contentType: false,
            data: formValues,
