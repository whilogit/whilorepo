                    ...
                    <div class="box box-color box-bordered" >
                        ...
                        <div class="box-content nopadding" >
                            ...
                            <div id="table_div">
                                ...
                                <thead>
                                <th width="1%">Sl-No</th>
                                <th width="3%">Industry  Name</th>
                                <th width="1%">Edit</th>
                                 <th width="1%">Delete</th>
                                </thead>
                                   <tbody><?php $i=0; ?>
                                         @foreach($data['industries'] as $list)
 <?php $i = $i + 1; ?>
                                                <tr role="row" class="odd">
                                                        <td><?php  echo $i; ?></td>
                                                        <td>{{ $list->industryName }}</td>
                                                         <td><button  class="btn btn-danger fa fa-pencil-square locationsedit" name="edit" value="edit" data-locid="<?php echo $list->industryId ?>" data-locname="<?php echo $list->industryName ?>"></button></td>
                                                <td><button  class="btn btn-danger fa fa-trash locationsdelete" name="delete" value="Delete" data-locid="<?php echo $list->industryId ?>"></button></td>
                                                </tr>
                                         @endforeach
...
$(document).ready(function () {
    ...
    $("#delete_posting").click(function () {
        ...
        $.ajax({
            url: '/dashboard/deleteindustries',
            type: 'POST',
            processData: false,
            contentType: false,
            data: formValues,
