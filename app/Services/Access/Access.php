...
use App\Services\Access\Company\CompanyJobs;
use App\Services\Access\Employee\EmployeeAccount;
...
class Access
{
    ...
    {
        //die(json_encode(EmployeeAccount::details()));
		return EmployeeAccount::details();
